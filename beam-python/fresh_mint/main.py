...
from fresh_mint.jobs.flink_kafka_example import run as run_flink_kafka_example
...
def main():
    ...
    elif job_name == "flink_kafka_example":
        run_flink_kafka_example(job_args)
